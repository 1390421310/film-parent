...
<body>
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x" action="modifyPwd">
				<input type="hidden" name="name" value="${sessionScope.sysname }">
				<div class="form-group">
					<div class="label">
						<label for="sitename">管理员帐号：</label>
					</div>
					<div class="field">
						<label style="line-height: 33px;" id="label_name"> ${sessionScope.sysname }</label>
					</div>
				</div>
				<div class="form-group">
					<div class="label">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="password" class="input w50" name="password" size="50" id="password"
							placeholder="请输入新密码"
				...
				<div class="form-group">
					...
					<div class="field">
						<button class="button bg-main icon-check-square-o" type="submit" id="button_modify">
							修改</button>
					</div>
				</div>
			</form>
