...
<body>
	<div class="registerDivPage container" style="height: 350px;">
    ...
    <div class="register_account_text">修改密码</div>
    <div class="registerInput ">
        <span class="registerInputIcon"><span class=" glyphicon glyphicon-user"></span></span>
        <input id="name" name="name" placeholder="请输入您的用户名" type="text">
    </div>
    <div class="registerInput">
